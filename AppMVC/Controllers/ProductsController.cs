...
namespace AppMVC.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        {
            _logger.LogInformation($"Controller Trying to get all products at :{DateTime.Now.TimeOfDay} ");
            _logger.Log(LogLevel.Information, "Trying to get all products");
        ...
        public async Task<IActionResult> Filter(string searchString)
        {
            ...
            _logger.Log(LogLevel.Information, "Filtrage");
            if (!string.IsNullOrEmpty(searchString))
            {
                var filteredResultNew = allProducts
                    ...
                    .ToList();
                _logger.Log(LogLevel.Information, $"Filrtrage String : {searchString}");
                _logger.Log(LogLevel.Information, $"Count Products : {filteredResultNew.Count}");
